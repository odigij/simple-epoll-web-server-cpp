...
namespace sews::architecture::telemetry::diagnostic::transport
{
	...
	{
		log(core::telemetry::diagnostic::LogType::INFO, "\033[36mBasic Logger:\033[0m Initialized.");
	}

	BasicLogger::~BasicLogger(void)
	{
		log(core::telemetry::diagnostic::LogType::INFO, "\033[36mBasic Logger:\033[0m Terminated.");
	}

	void BasicLogger::log(core::telemetry::diagnostic::LogType flag, std::string_view message)
	{
		std::ostream &out = (flag == core::telemetry::diagnostic::LogType::ERROR) ? std::cerr : std::cout;
		switch (flag)
		{
			case core::telemetry::diagnostic::LogType::INFO:
				out << "\033[32m"; // Green
				break;
			case core::telemetry::diagnostic::LogType::WARNING:
				out << "\033[33m"; // Yellow
				break;
			case core::telemetry::diagnostic::LogType::ERROR:
				out << "\033[31m"; // Red
				break;
			default:
				out << "\033[0m"; // Reset
